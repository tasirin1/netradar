...
class MainActivity : AppCompatActivity() {
    ...
    private val webPaths = listOf(
        ...
        "/admin/login", "/admin/login.htm", "/admin/login.html", "/admin/login.php",
        "/admin/index", "/admin/index.html", "/admin/index.php", "/admin/home",
        "/admin/status", "/admin/config", "/admin/setup", "/admin/system",
        "/admin/backup", "/admin/restore", "/admin/reboot", "/admin/upgrade",
        "/admin/password", "/admin/users", "/admin/log", "/admin/logs",
        "/admin/network", "/admin/wireless", "/admin/wifi", "/admin/dhcp",
        "/admin/firewall", "/admin/nat", "/admin/forward", "/admin/dmz",
        "/admin/routing", "/admin/vpn", "/admin/ddns", "/admin/tools",
        "/admin/manage", "/admin/management", "/admin/settings",
        "/api/", "/api/v1/", "/api/v1/login", "/api/v1/status", "/api/v1/config",
        "/api/v1/system", "/api/v1/reboot", "/api/v1/restart",
        "/api/v1/backup", "/api/v1/restore", "/api/v1/upgrade",
        "/api/v1/users", "/api/v1/admin", "/api/v1/info",
        "/api/login", "/api/status", "/api/config", "/api/system",
        "/api/reboot", "/api/restart", "/api/backup",
        "/rest/", "/rest/login", "/rest/status", "/rest/config",
        "/graphql", "/swagger", "/swagger-ui", "/api-docs",
        "/backup.bin", "/backup.cfg", "/backup.conf", "/backup.tar", "/backup.gz",
        "/config.bin", "/config.cfg", "/config.conf", "/config.dat",
        "/settings.bin", "/settings.cfg", "/settings.conf", "/settings.dat",
        "/nvram.bin", "/nvram.cfg", "/nvram.conf",
        "/romfile.cfg", "/rom-0", "/router.cfg", "/router.conf",
        "/system.cfg", "/system.conf", "/system.dat",
        "/user.cfg", "/user.conf", "/user.dat",
        "/admin.cfg", "/admin.conf", "/admin.dat",
        "/db.json", "/db.xml", "/db.sqlite", "/db.sql",
        "/wp-config.php", "/wp-config.bak", "/wp-config.old",
        ".git/config", ".git/HEAD", ".svn/entries",
        "/Main_Login.asp", "/login.asp", "/Login.asp",
        "/userRpm/", "/userRpm/Index.htm", "/userRpm/Login.htm",
        "/userRpm/StatusRpm.htm", "/userRpm/SysRebootRpm.htm",
        "/cgi-bin/webcm", "/cgi-bin/webcm?getpage=../../",
        "/cgi-bin/luci", "/cgi-bin/luci/", "/luci",
        "/cgi-bin/luci/admin", "/cgi-bin/luci/admin/status",
        "/cgi-bin/luci/admin/system", "/cgi-bin/luci/admin/reboot",
        "/goform/", "/goform/login", "/goform/status",
        "/goform/config", "/goform/setup", "/goform/system",
        "/goform/backup", "/goform/restore", "/goform/upgrade",
        "/goform/reboot", "/goform/restart", "/goform/password",
        "/goform/wifi", "/goform/network", "/goform/dhcp",
        "/goform/SysToolRestore", "/goform/SysToolUpgrade",
        "/goform/SysToolBackup", "/goform/SysToolPing",
        "/goform/SysToolTraceroute", "/goform/SysToolPassword",
        "/test", "/test.htm", "/test.php", "/test.cgi",
        "/debug.cgi", "/debug.php", "/debug.asp",
        "/info.cgi", "/info.php", "/info.asp",
        "/phpinfo.php", "/info.php", "/status.php",
        "/console", "/terminal", "/exec.cgi", "/cmd.cgi",
        "/ping", "/ping.cgi", "/ping.php",
        "/traceroute", "/traceroute.cgi", "/trace",
        "/web/", "/web/cgi-bin/", "/web/cgi-bin/hi3510",
        "/web/cgi-bin/hi3510/param.cgi", "/web/cgi-bin/hi3510/snap.cgi",
        "/cgi-bin/hi3510/", "/cgi-bin/hi3510/param.cgi",
        "/cgi-bin/snapshot.cgi", "/cgi-bin/video.cgi",
        "/cgi-bin/mjpg/mjpg.cgi", "/cgi-bin/view.cgi",
        "/onvif/device_service", "/onvif/", "/onvif",
        "/axis-cgi/", "/axis-cgi/admin/",
        "/doc/page/login.asp",
        "/ftp", "/ftp/", "/samba", "/smb",
        "/share", "/shares", "/files", "/download",
        "/upload", "/uploads", "/downloads",
        "/public", "/private", "/tmp", "/temp", "/log",
        "/var/log", "/var/log/messages",
        "/mnt", "/mnt/sdcard", "/mnt/usb",
        "/net/", "/network", "/workgroup",
        "/", "/index.asp", "/index.jsp", "/index.aspx",
        "/default.htm", "/default.html", "/default.asp", "/default.php",
        "/main.htm", "/main.html", "/main.asp", "/main.php",
        "/home.htm", "/home.html", "/home.asp", "/home.php",
        "/help", "/help.htm", "/help.html",
        "/about", "/about.htm", "/about.html",
        "/contact", "/contact.htm", "/contact.html",
        "/support", "/support.htm", "/support.html",
        "/license", "/license.htm", "/license.html",
        "/terms", "/privacy", "/copyright",
        "/sso", "/oauth", "/oauth2",
        "/register", "/registration", "/signup",
        "/forgot", "/forgot_password", "/reset",
